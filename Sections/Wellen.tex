...
\end{center}
\begin{center}
	\textbf{Siehe Tabellen für Konstanten!}
\end{center}
\begin{center}
	\begin{minipage}{0.3\textwidth}
		...
		\unitText{$M$}{Molare Masse (\refkuchling{260})}{$\frac{kg}{mol}$} \\
...
\begin{center}
	\begin{minipage}{0.2\textwidth}
		...
		\formula{$f' = \dfrac{1}{1 - \dfrac{v_Q}{u} \cos(\vartheta_Q)} f$}
	\end{minipage}%%% to prevent a space
	\begin{minipage}{0.3\textwidth}
...
\begin{center}
	\begin{minipage}{0.3\textwidth}
		...
		\formula{$f' = \dfrac{u + v_B \cos(\vartheta_B)}{u - v_Q \cos(\vartheta_Q)} f$}
	\end{minipage}%%% to prevent a space
	\begin{minipage}{0.2\textwidth}
...
\begin{minipage}{0.25\textwidth}
	...
	\unitText{$f$}{Frequenz bei der Quelle}{$Hz$} \\
